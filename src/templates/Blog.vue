    ...
    <div style="min-height: 600px" v-loading="loading">
        <el-card shadow="never" style="min-height: 400px">
            ...
            <div style="font-size: 0.9rem;line-height: 1.5;color: #606c71;">
                发布 {{ $page.blog.created_at | timeFileter }}
                <br> 更新 {{ $page.blog.updated_at | timeFileter }}
            </div>
            ...
            <div v-html="mdH5" class="markdown-body" style="padding-top: 20px"></div>
        </el-card>
    </div>
</template>
<page-query>
    ...
    export default {
       metaInfo: {
        ...
        computed: {
            ...
            mdH5: function () {
              // `this` 指向 vm 实例
              return this.$markdown(this.$page.blog.content)
            }
        },
        mounted() {
            this.loading = true
            this.blog.id = this.$route.params.id
            console.log(this.$page.blog)
